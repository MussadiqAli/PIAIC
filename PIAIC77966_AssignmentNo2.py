...
def function2():
    ...
    x = np.arange(10,37,dtype=np.float64).reshape((3,3,3))     #x = np.arange(10,37,dtype=np.float64).reshape((3,3,3))
...
def function8():
    ...
    x = np.array([6,6,6,6,6,6,6,6,6,6], dtype=np.uint32).reshape(2,5) #write your code here
...
def function14():
    ...
    ans = np.split(arr,[6,12,18]) #write your code here 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.concatenate((x,y),axis=1).reshape((3,2))#write your code here 
...
def function17():
    ...
    return np.where(arr%3==0,np.where(arr%5==0,"YES","NO"),"NO")  # Write Your Code HERE
...
def function19():
    ...
    W = X;W=W.transpose()  # Write your code here 
